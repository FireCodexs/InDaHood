...
function Header() {
  ...
  return (
    <div className="w-full h-96 bg-[url('https://images.unsplash.com/photo-1529333166437-7750a6dd5a70?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1738&q=80')] bg-cover bg-center">
    <div className="bg-gradient-to-b from-yellow-300 to-transparent">


      <h1 className=" subpixel-antialiased font-cursive text-center pt-5 text-9xl text-[#FFA600]">Spring</h1>
