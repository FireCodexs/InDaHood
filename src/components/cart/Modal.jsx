...
export default function Modal() {
  ...
  return (
    <>
      <button 
        className="top-[8%] right-0 fixed bg-pink-500 text-white active:bg-pink-600 font-bold uppercase text-sm px-4 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
        type="button"
