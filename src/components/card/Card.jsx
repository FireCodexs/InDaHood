...
const Card = ({product, handleAddToCart }) => {
    const { name, price, image, hoverImage,id } = product;
        ...
        items-center">
            ...
            <div className="p-6 flex flex-col gap-3">
                ...
                <div className="flex gap-2">
                    ...
                    <button onClick={() =>handleClick(id)} className='flex-grow flex justify-center items-center bg-gray-300/60 hover:bg-gray-300/80 transition rounded-md'>
